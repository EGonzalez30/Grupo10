<%-- 
    Document   : insertardepart
    Created on : 11-21-2021, 10:30:00 PM
    Author     : Pacheco
--%>
...
<html>
    <head>
        ...
        <title>DEPARTAMENTOS | Agregar</title>
                    ...
                    <div class="container w-150 my-10">
                        <div class="row">
                            <div class="col-lg-20 mb-4 " style="width: 100%;">
                                ...
                                <form action="departamento?action=insertar" method="POST">
                                    <div class="form-group has-feedback mb-4">
                                        <input type="text" class="form-control" name="departamento" placeholder="DEPARTAMENTO DE RESIDENCIA">
                                    ...
                                    <div class="form-group has-feedback mb-4">
                                        <input type="text" class="form-control" name="area_trabajo" placeholder="AREA DE TRABAJO">
                                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                    </div>
