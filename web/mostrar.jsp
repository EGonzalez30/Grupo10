<%-- 
    Document   : mostrar
    Created on : 11-21-2021, 10:31:04 PM
    Author     : Pacheco
--%>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h1 class="box-title">TABLA EMPLEADOS</h1>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table class="table responsive-table highlight table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach items="${lista}" var="ver">
                                                <tr>
                                                    <td>${ver.id_empleado}</td>
                                                    <td>${ver.dni}</td>
                                                    <td>${ver.numero_ss}</td>
                                                    <td>${ver.cod_trabajador}</td>
                                                    <td>${ver.nombre}</td>
                                                    <td>${ver.apellido}</td>
                                                    <td>${ver.direccion}</td>
                                                    <td>${ver.telefono}</td>
                                                    <td>
                                                        <a type="button" class="btn bg-red btn-flat margin" href="empleado?action=eliminar&id_empleado=${ver.id_empleado}">ELIMINAR</a>
                                                        <a type="button" class="btn bg-orange btn-flat margin" href="empleado?action=seleccionaByid&id_empleado=${ver.id_empleado}">ACTUALIZAR</a>
                                                    </td>
                                                </tr>
                                            </c:forEach> 
                                        </tbody>
