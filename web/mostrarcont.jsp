<%-- 
    Document   : mostrarcont
    Created on : 11-21-2021, 10:31:16 PM
    Author     : Pacheco
--%>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h1 class="box-title">TABLA NOMINAS</h1>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table class="table responsive-table highlight table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach items="${lista}" var="ver">
                                                <tr>
                                                    <td>${ver.id_contrato}</td>
                                                    <td>${ver.id_empleado.id_empleado}</td>
                                                    <td>${ver.fecha_inicial}</td>
                                                    <td>${ver.fecha_final}</td>
                                                    <td>
                                                        <a type="button" class="btn bg-red btn-flat margin" href="contrato?action=eliminar&id_contrato=${ver.id_contrato}">ELIMINAR</a>
                                                        <a type="button" class="btn bg-orange btn-flat margin" href="contrato?action=seleccionaByid&id_contrato=${ver.id_contrato}">ACTUALIZAR</a>
                                                    </td>
                                                </tr>
                                            </c:forEach> 
                                        </tbody>
