<%-- 
    Document   : indexnomina
    Created on : 11-21-2021, 10:27:30 PM
    Author     : Pacheco
--%>
...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container w-150 my-10">
                        <div class="row">
                            <div class="col-lg-20 mb-4 " style="width: 100%;">
                                <div class="text-center">
                                    <h2>REGISTRO NOMINA</h2>
                                </div>
                                <form action="nominas?action=insertar" method="POST">
                                    <div class="form-group has-feedback mb-4">
                                        <select type="id_empleado" name="id_empleado" placeholder="EMPLEADO" class="form-control select2" style="width: 100%;">
                                            <c:forEach items="${empleados}" var="e">
                                                <option value="${e.getId_empleado()}">${e.getNombre()}</option>
                                            </c:forEach>
                                        </select>
                                    </div>

                                    <div class="form-group has-feedback mb-4">
                                        <select type="id_cargo" name="id_cargo" placeholder="CARGO" class="form-control select2" style="width: 100%;">
                                            <c:forEach items="${cargo}" var="e">
                                                <option value="${e.getId_cargo()}">${e.getTipo_cargo()}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                ...
                                <div class="col s12 m6 l6">
                                    <a class="btn bg-green btn-primary btn-block" href="nominas?action=seleccionar">MOSTRAR</a>
                                </div>
                            </div>
                        </div>                                               
                    </div>
        ...
        <!-- Select2 -->
        <script src="recursos/bower_components/select2/dist/js/select2.full.min.js"></script>
        <!-- InputMask -->
        ...
        <!-- bootstrap color picker -->
        <script src="recursos/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>
        <!-- bootstrap time picker -->
