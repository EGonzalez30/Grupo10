<%-- 
    Document   : index
    Created on : 11-21-2021, 10:26:57 PM
    Author     : Pacheco
--%>
                    ...
                    <div class="container w-150 my-10">
                        <div class="row">
                            <div class="col-lg-20 mb-4 " style="width: 100%;">
                                ...
                                <form action="empleado?action=insertar" method="POST">
                                    ...
                                    <div class="form-group has-feedback mb-4">
                                        <input type="number" class="form-control" name="numero_ss" placeholder="NUMERO SEGURO SOCIAL">
                                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                    </div>

                                    <div class="form-group has-feedback mb-4">
                                        <input type="text" class="form-control" name="cod_trabajador" placeholder="CODIGO DE TRABAJADOR">
                                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                    </div>
