<%-- 
    Document   : actualizarnomina
    Created on : 11-21-2021, 10:26:47 PM
    Author     : Pacheco
--%>
...
<html>
    <head>
        ...
        <title>NOMINAS | Actualizar</title>
                    ...
                    <div class="container w-150 my-10">
                        <div class="row">
                            <div class="col-lg-20 mb-4">
                                ...
                                <form action="nominas?action=actualizar" method="POST">
                                    <c:forEach items="${lista}" var="ver">  
                                        <div class="form-group has-feedback mb-4">
                                            <input type="number" class="form-control" name="id_nomina" placeholder="ID NOMINA" value="${ver.id_nomina}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>
                                            
                                        <div class="form-group has-feedback mb-4">
                                            <input type="number" class="form-control" name="id_empleado" placeholder="EMPLEADO" value="${ver.id_empleado.id_empleado}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>

                                        <div class="form-group has-feedback mb-4">
                                            <input type="number" class="form-control" name="id_cargo" placeholder="CARGO" value="${ver.id_cargo.id_cargo}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>

                                        <div class="form-group has-feedback mb-4">
                                            <input type="text" class="form-control" name="fecha_nacimiento" placeholder="FECHA NACIMIENTO" value="${ver.fecha_nacimiento}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>

                                        <div class="form-group has-feedback mb-4">
                                            <input type="number" class="form-control" name="salario" placeholder="SALARIO" value="${ver.salario}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>
