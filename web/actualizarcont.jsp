<%-- 
    Document   : actualizarcont
    Created on : 11-21-2021, 10:24:17 PM
    Author     : Pacheco
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Contratos
                        <small>Actualizar contrato</small>
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="container w-150 my-10">
                        <div class="row">
                            <div class="col-lg-20 mb-4">
                                ...
                                <form action="contrato?action=actualizar" method="POST">
                                    <c:forEach items="${lista}" var="ver">  
                                        <div class="form-group has-feedback mb-4">
                                            <input type="number" class="form-control" name="id_contrato" placeholder="ID CONTRATO" value="${ver.id_contrato}">
                                        ...
                                        <div class="form-group has-feedback mb-4">
                                            <input type="text" class="form-control" name="fecha_inicial" placeholder="FECHA DE INICIO" value="${ver.fecha_inicial}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>

                                        <div class="form-group has-feedback mb-4">
                                            <input type="text" class="form-control" name="fecha_final" placeholder="FECHA DE FINALIZACIÓN" value="${ver.fecha_final}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>
                                ...
                                <div class="col s12 m6 l6">
                                    <a class="waves-effect waves-light btn-small" href="contrato?action=seleccionar">MOSTRAR</a>
                                </div>
                            </div>
                        </div>                                               
                    </div>
