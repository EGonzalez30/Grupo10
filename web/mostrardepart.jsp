<%-- 
    Document   : mostrardepart
    Created on : 11-21-2021, 10:31:30 PM
    Author     : Pacheco
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Departamento
                        <small>Mostrar departamentos</small>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h1 class="box-title">TABLA DEPARTAMENTOS</h1>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table class="table responsive-table highlight table-bordered table-hover">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <c:forEach items="${lista}" var="ver">
                                                <tr>
                                                    <td>${ver.id_departamento}</td>
                                                    <td>${ver.departamento}</td>
                                                    <td>${ver.ciudad}</td>
                                                    <td>${ver.area_trabajo}</td>
                                                    <td>
                                                        <a type="button" class="btn bg-red btn-flat margin" href="departamento?action=delete&id_departamento=${ver.id_departamento}">ELIMINAR</a>
                                                        <a type="button" class="btn bg-orange btn-flat margin" href="departamento?action=seleccionarById&id_departamento=${ver.id_departamento}">ACTUALIZAR</a>
                                                    </td>
                                                </tr>
                                            </c:forEach> 
                                        </tbody>
