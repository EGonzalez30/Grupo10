<%-- 
    Document   : actualizar
    Created on : 11-21-2021, 10:24:02 PM
    Author     : Pacheco
--%>
...
<html>
    <head>
        ...
        <title>EMPLEADOS | Actualizar</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Empleados
                        <small>Actualizar empleado</small>
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="container w-150 my-10">
                        <div class="row">
                            <div class="col-lg-20 mb-4">
                                ...
                                <form action="empleado?action=actualizar" method="POST">
                                    <c:forEach items="${lista}" var="ver">  
                                        <div class="form-group has-feedback mb-4">
                                            <input type="number" class="form-control" name="id_empleado" placeholder="ID EMPLEADO" value="${ver.id_empleado}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>
                                            
                                        <div class="form-group has-feedback mb-4">
                                            <input type="number" class="form-control" name="dni" placeholder="DNI" value="${ver.dni}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>

                                        <div class="form-group has-feedback mb-4">
                                            <input type="number" class="form-control" name="numero_ss" placeholder="NUMERO SEGURO SOCIAL" value="${ver.numero_ss}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>

                                        <div class="form-group has-feedback mb-4">
                                            <input type="text" class="form-control" name="cod_trabajador" placeholder="CODIGO DE TRABAJADOR" value="${ver.cod_trabajador}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>
                                        ...
                                        <div class="form-group has-feedback mb-4">
                                            <input type="text" class="form-control" name="direccion" placeholder="DIRECCION" value="${ver.direccion}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>

                                        <div class="form-group has-feedback mb-4">
                                            <input type="text" class="form-control" name="telefono" placeholder="TELEFONO" value="${ver.telefono}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>
                                ...
                                <div class="col s12 m6 l6">
                                    <a class="btn bg-green btn-primary btn-block" href="empleado?action=seleccionar">MOSTRAR</a>
                                </div>
                            </div>
                        </div>                                               
                    </div>
