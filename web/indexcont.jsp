<%-- 
    Document   : indexcont
    Created on : 11-21-2021, 10:27:11 PM
    Author     : Pacheco
--%>
                    ...
                    <div class="container w-150 my-10">
                        <div class="row">
                            <div class="col-lg-20 mb-4 " style="width: 100%;">
                                ...
                                <form action="contrato?action=insertar" method="POST">
                                    ...
                                    <div class="form-group has-feedback mb-4">
                                        <input type="text" class="form-control" name="fecha_inicial" placeholder="FECHA DE INICIO">
                                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                    </div>

                                    <div class="form-group has-feedback mb-4">
                                        <input type="text" class="form-control" name="fecha_final" placeholder="FECHA DE FINALIZACIÓN">
                                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                    </div>                                   
                                ...
                                <div class="col s12 m6 l6">
                                    <a class="btn bg-green btn-primary btn-block" href="contrato?action=seleccionar">MOSTRAR</a>
                                </div>
                            </div>
                        </div>                                               
                    </div>
