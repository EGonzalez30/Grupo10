<%-- 
    Document   : mostrarnomina
    Created on : 11-21-2021, 10:31:50 PM
    Author     : Pacheco
--%>
                                        ...
                                        <tbody>
                                            <c:forEach items="${lista}" var="ver">
                                                <tr>
                                                    ...
                                                    <td>${ver.id_cargo.id_cargo}</td>
                                                    <td>${ver.fecha_nacimiento}</td>
                                                    <td>${ver.salario}</td>
                                                    <td>
                                                        <a type="button" class="btn bg-red btn-flat margin" href="nominas?action=eliminar&id_nomina=${ver.id_nomina}">ELIMINAR</a>
                                                        <a type="button" class="btn bg-orange btn-flat margin" href="nominas?action=seleccionaByid&id_nomina=${ver.id_nomina}">ACTUALIZAR</a>
                                                    </td>
                                                </tr>
                                            </c:forEach> 
                                        </tbody>
