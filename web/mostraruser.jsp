<%-- 
    ...
    Created on : 12-09-2021, 01:09:35 AM
    Author     : Pacheco
--%>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h1 class="box-title">TABLA USUARIOS</h1>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                        ...
                                        <tbody>
                                            <c:forEach items="${lista}" var="ver">
                                                <tr>
                                                    ...
                                                    <td>${ver.clave}</td>
                                                    <td>
                                                        <a type="button" class="btn bg-red btn-flat margin" href="usuario?action=eliminar&id_usuario=${ver.id_usuario}">ELIMINAR</a>
                                                        <a type="button" class="btn bg-orange btn-flat margin" href="usuario?action=seleccionaByid&id_usuario=${ver.id_usuario}">ACTUALIZAR</a>
                                                    </td>
                                                </tr>
                                            </c:forEach> 
                                        </tbody>
