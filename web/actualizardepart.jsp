<%-- 
    Document   : actualizardepart
    Created on : 11-21-2021, 10:26:30 PM
    Author     : Pacheco
--%>
...
<html>
    <head>
        ...
        <title>DEPARTAMENTOS | Actualizar</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Departamentos
                        <small>Actualizar departamento</small>
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="container w-150 my-10">
                        <div class="row">
                            <div class="col-lg-20 mb-4">
                                ...
                                <form action="departamento?action=update" method="POST">
                                    <c:forEach items="${lista}" var="ver">  
                                        <div class="form-group has-feedback mb-4">
                                            <input type="number" class="form-control" name="id_departamento" placeholder="ID DEPARTAMENTO" value="${ver.id_departamento}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>
                                            
                                        <div class="form-group has-feedback mb-4">
                                            <input type="text" class="form-control" name="departamento" placeholder="DEPARTAMENTO DE RESIDENCIA" value="${ver.departamento}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>

                                        <div class="form-group has-feedback mb-4">
                                            <input type="text" class="form-control" name="ciudad" placeholder="CIUDAD" value="${ver.ciudad}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>

                                        <div class="form-group has-feedback mb-4">
                                            <input type="text" class="form-control" name="area_trabajo" placeholder="AREA DE TRABAJO" value="${ver.area_trabajo}">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>
                                ...
                                <div class="col s12 m6 l6">
                                    <a class="btn bg-green btn-primary btn-block" href="departamento?action=seleccionar">MOSTRAR</a>
                                </div>
                            </div>
                        </div>                                               
                    </div>
