<%-- 
    Document   : insertarcargo
    Created on : 11-21-2021, 10:28:44 PM
    Author     : Pacheco
--%>
                        ...
                        <div class="row">
                            <div class="col-lg-20 mb-4">
                                <div class="text-center">
                                    <h2>REGISTRO CARGO</h2>
                                </div>
                                <form action="cargo?action=insertar" method="POST">
                                    ...
                                    <div class="form-group has-feedback mb-4">
                                        <select type="id_departamento" name="id_departamento" placeholder="DEPARTAMENTO" class="form-control select2" style="width: 100%;">
                                            <c:forEach items="${departamento}" var="e">
                                                <option value="${e.getId_departamento()}">${e.getArea_trabajo()}</option>
                                            </c:forEach>
                                        </select> 
                                    </div>

                                    <div class="form-group has-feedback mb-4">
                                        <input type="text" class="form-control" name="tipo_cargo" placeholder="TIPO DE CARGO">
                                ...
                                <div class="col s12 m6 l6">
                                    <a class="btn bg-green btn-primary btn-block" href="cargo?action=seleccionar">MOSTRAR</a>
                                </div>
                            </div>
                        </div>                                               
                    </div>
